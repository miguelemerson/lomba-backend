...
export interface PostRepository {
    ...
    updatePost(postId: string, userId: string, title: string, textContent: TextContent | undefined, imageContent: ImageContent | undefined, videoContent: VideoContent | undefined, categoryNames:string[]): Promise<Either<Failure, ModelContainer<Post>>>;
    ...
    addMultiPost(orgaId: string, userId: string, flowId: string, title: string, textContent: TextContent | undefined, imageContent: ImageContent | undefined, videoContent: VideoContent | undefined, categoryNames:string[], draft: boolean): Promise<Either<Failure, ModelContainer<Post>>>;
}