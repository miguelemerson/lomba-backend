...
export interface PostRepository {
    getPosts(orgaId: string, userId: string, flowId: string, stageId: string, boxPage: string, textSearch: string, sort?: [string, 1 | -1][], pageIndex?: number, itemsPerPage?: number, params?: Map<string, unknown> | undefined): Promise<Either<Failure, ModelContainer<Post>>>;
