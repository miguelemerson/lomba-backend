...
export interface AddOrgaUserUseCase {
    execute(orgaUser: OrgaUserModel): Promise<Either<Failure, ModelContainer<OrgaUserModel>>>;
}
...
export class AddOrgaUser implements AddOrgaUserUseCase {
	...
	async execute(orgaUser: OrgaUserModel): Promise<Either<Failure,ModelContainer<OrgaUserModel>>> {
