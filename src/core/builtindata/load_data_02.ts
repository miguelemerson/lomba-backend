...
export const data_insert02 = {
	...
	posts:[{postitems:[], title:'primer post del sistema', orgaId: data_insert01.orgas[1].id, userId: data_insert01.users[4].id, flowId:flowId, stageId: stageId01Load, stages:[], totals:[], tracks:[], votes:[], _id:post01Id, id:post01Id, enabled:true, builtIn:true, created: new Date(), totalfav:0, totalsave:0, totalreport:0} as Post, {postitems:[], title:'este es el segundo post', orgaId: data_insert01.orgas[1].id, userId: data_insert01.users[4].id, flowId:flowId, stageId: stageId01Load, stages:[], totals:[], tracks:[], votes:[], _id:post02Id, id:post02Id, enabled:true, builtIn:true, created: new Date(), totalfav:0, totalsave:0, totalreport:0} as Post, {postitems:[], title:'tercer post en fila', orgaId: data_insert01.orgas[1].id, userId: data_insert01.users[5].id, flowId:flowId, stageId: stageId01Load, stages:[], totals:[], tracks:[], votes:[], _id:post03Id, id:post03Id, enabled:true, builtIn:true, created: new Date(), totalfav:0, totalsave:0, totalreport:0} as Post, {postitems:[], title:'cuarto post nacido en etapa 2', orgaId: data_insert01.orgas[1].id, userId: data_insert01.users[5].id, flowId:flowId, stageId: stageId02Approval, stages:[], totals:[], tracks:[], votes:[], _id:post04Id, id:post04Id, enabled:true, builtIn:true, created: new Date(), totalfav:0, totalsave:0, totalreport:0} as Post],
