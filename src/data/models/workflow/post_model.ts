...
export class PostModel implements Post {
	...
	public toEntity(): Post {
		return {id: this.id, _id:this.id, postitems:this.postitems, title:this.title, orgaId:this.orgaId, userId:this.userId, flowId:this.flowId, stageId:this.stageId, stages:this.stages, totals:this.totals, tracks:this.tracks, votes:this.votes, bookmarks:this.bookmarks, enabled: this.enabled, builtIn: this.builtIn, created: this.created, updated: this.updated, deleted: this.deleted, expires: this.expires, totalsaves: this.totalsaves, totalfavs: this.totalfavs, totalreports: this.totalreports, totalcomments: this.totalcomments, totaldownloads: this.totaldownloads};
	}
}