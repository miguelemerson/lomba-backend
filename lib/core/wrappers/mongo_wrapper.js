...
class MongoWrapper {
    ...
    getMany(query, sort, pageIndex, itemsPerPage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result == null)
                return null;
            const contains_many = this.createContainsMany(result, itemsPerPage, pageIndex, startIndex, totalItems, totalPages);
            return contains_many;
        });
    }
    createContainsMany(result, itemsPerPage, pageIndex, startIndex, totalItems, totalPages) {
        const contains_many = new contains_many_1.ContainsMany(result);
    ...
    add(obj) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rn = yield this.getOne(result.insertedId.toString());
            return rn;
        });
    }
    update(id, obj) {
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (rn != null) {
                yield this.db.collection(this.collectionName + '_deleted').insertOne(rn);
